...
void remc(void);            // removes character from video output (backspace)
void rem_cursor(void);      // removes cursor from video output
void clear_screen(void);    // clears the screen
void put_cursor(void);      // draws the cursor
void check_cursor(void);    // get rid of '_' on every '\n' and backspace
void delete_cursor();
